...
export default function CommandsPage() {
  ...
  const handleDelete = async (key: string) => {
    if (window.confirm(`¿Seguro que deseas eliminar /${key}?`)) {
      try {
  ...
  return (
    <main className="pb-24 animate-fade-in relative" style={{ top: 'var(--tg-top-offset, 0px)' }}>
      ...
      <div className="relative pt-8 pb-6 px-6 text-center bg-gradient-to-b from-tg-accent/10 to-transparent border-b border-white/5">
        ...
        <h1 className="text-[24px] font-extrabold text-tg-text tracking-tight">Comandos</h1>
        <p className="text-tg-hint text-[14px] max-w-[280px] mx-auto mt-2 leading-relaxed">
          Crea, edita o elimina comandos personalizados para extender las funciones de tu bot.
        </p>
      </div>
      ...
      <div className="px-4 mt-5">
        ...
        <h2 className="text-[12px] font-bold text-tg-hint uppercase tracking-widest pl-2 mb-2">
          Lista de Comandos ({entries.length})
        </h2>
                ...
                <div className="overflow-hidden bg-black/10 border-t border-white/5">
                  <div className="p-4 space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold text-tg-hint/70 uppercase tracking-widest pl-1">Comando</label>
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold text-tg-hint/70 uppercase tracking-widest pl-1">Motor (Engine)</label>
        ...
        <div className="mt-6 px-2 text-center flex items-start gap-2 justify-center">
          ...
          <p className="text-[13px] text-tg-hint leading-relaxed max-w-[280px]">
            Los comandos definen cómo responde Trelk Bot a peticiones específicas de texto.
          </p>
        </div>
      </div>
    </main>
