        ...
        return (
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <div className="text-[15px] font-bold text-tg-text font-mono  truncate">/{slug}</div>
        ...
        >
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0 pt-0.5">
                    <div className="text-[16px] font-extrabold text-tg-text font-mono  truncate">/{slug}</div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-3.5">
                        ...
                        {cmd.supportsInline && (
                            <span className="text-[10px] font-extrabold uppercase  px-2.5 py-1 rounded-full shadow-sm text-blue-400 bg-blue-500/10 border border-blue-500/20">
                                Inline
                            </span>
                        )}
                    </div>
